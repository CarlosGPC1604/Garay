    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
            ...
            <div className="grid grid-cols-2 gap-5 lg:gap-2 overflow-hidden">
                {/* Card-1 */}
                <div className="mx-auto flex items-center justify-center overflow-hidden bg-[#1b1b1b] h-[150px] w-[150px] sm:h-[250px] sm:w-[250px] lg:h-auto lg:w-[100%]">
                    <div >
                        <svg className='text-[#bd1622] transition-transform duration-300 ease-in-out transform hover:translate-y-3' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16">
