...
const cardsData = [
    {
        ...
        icon: (
            <svg
                className="mx-auto text-[#231f20] dark:text-white"
                xmlns="https://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                    <div className='glass p-4 lg:p-8 h-full flex items-center justify-center'>
                        <div className="mx-auto text-center lg:text-right">
                            ...
                            <p className="text-[#231f20] dark:text-white text-wrap-balance mt-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 overflow-hidden">
                        ...
                        {cardsData.map(card => (
                            <div key={card.id} className="glass mx-auto flex items-center justify-center relative overflow-hidden py-12 w-full">
                                <div>
                                    {card.icon}
                                    <p className="text-[#231f20] dark:text-white mt-3 text-center">
                                        {card.description}
                                    </p>
                                    <div className="opacity-0 hover:opacity-100 absolute top-0 left-0 w-full h-full flex items-center justify-center">
                                        <div className="absolute inset-0 bg-[#c5c5c5] dark:bg-[#3f3f41]"></div>
                                        <div className="text-[#231f20] dark:text-white relative z-10 text-center p-1 lg:p-3">
                                            <p>
                                                {card.service}
                                            </p>
                                        </div>
