...
export default function App() {
  ...
  return (
    <Accordion>
      <AccordionItem className="font-black" key="1" aria-label="Accordion 1" title="Diseño Arquitectonico">
      ...
      <AccordionItem className="font-black" key="2" aria-label="Accordion 2" title="Planificacion de proyectos">
      ...
      <AccordionItem className="font-black" key="3" aria-label="Accordion 3" title="Supervicion de obra">
